<div>
    <flux:heading size="xl" class="mb-6 text-center">Create an account</flux:heading>

    <form wire:submit="register" class="flex flex-col gap-4">
        <flux:input wire:model="name" label="Name" type="text" autocomplete="name" required autofocus />
    ...
    <flux:button href="{{ route('auth.github') }}" variant="filled" class="w-full">
