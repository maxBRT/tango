<div>
    <flux:heading size="xl" class="mb-6 text-center">Log in</flux:heading>

    <form wire:submit="authenticate" class="flex flex-col gap-4">
        <flux:input wire:model="email" label="Email" type="email" autocomplete="email" required autofocus />
